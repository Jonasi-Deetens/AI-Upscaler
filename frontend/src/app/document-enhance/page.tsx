...
export default function DocumentEnhancePage() {
    ...
    <main className="min-h-screen bg-background text-foreground">
      <div className="max-w-6xl mx-auto px-5 py-12">
        ...
        <p className="text-muted-foreground mb-6">
          Clean up photos of documents: deskew, denoise, and optionally binarize for clearer text.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            <Toggle
              id="binarize"
              pressed={binarize}
              onPressedChange={setBinarize}
              aria-label="Binarize output (black and white text)"
            />
            <label htmlFor="binarize" className="text-sm font-medium">
              Binarize (black & white for text)
            </label>
          </div>
          {uploadProgress != null && (

  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { job_ids } = await uploadJobsWithProgress(
        files,
        { scale: 1, method: "favicon", options: {} },
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <div className="max-w-6xl mx-auto px-5 py-12">
        ...
        <h1 className="text-3xl font-bold text-foreground mb-6">Favicon generator</h1>
        <p className="text-muted-foreground mb-6">
          Upload an image to generate favicon.ico with 16×16, 32×32, and 48×48. Download from Jobs.
        </p>

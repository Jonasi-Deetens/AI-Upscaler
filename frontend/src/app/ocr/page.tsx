  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <div className="max-w-6xl mx-auto px-5 py-12">
        ...
        <h1 className="text-3xl font-bold text-foreground mb-6">OCR</h1>
        <p className="text-muted-foreground mb-6">
          Upload images or PDFs to extract text. One job per file; download the .txt result from Jobs.
        </p>
